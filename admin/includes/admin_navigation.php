<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Learners System Admin</a>
            </div>
            <!-- Top Menu Items -->
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#demo"><i class="fa fa-fw fa-arrows-v"></i> Learners <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="demo" class="collapse">
                            <li>
                                <a href="Learners.php">All Learners</a>
                            </li>
                            <li>
                                <a href="Learners.php?source=add_Learners">Add Learners</a>
                            </li>
                        </ul>
                    </li>
                    <li>
					...
					<li>
                        <a href="Bookings.php"><i class="fa fa-fw fa-dashboard"></i>Bookings</a>
                    </li>
                    <li>
